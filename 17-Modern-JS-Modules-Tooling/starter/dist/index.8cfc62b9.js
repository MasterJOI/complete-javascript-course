...
_shoppingCartJs.addToCard("apple", 10);
console.log(_shoppingCartJs.prise);
...
(0, _shoppingCartJsDefault.default)("cocks", 555);
// prove that if we change export variable, it changes in all imports
console.log(_shoppingCartJs.card);
...
console.log(data);*/ // with async function main thread won`t be blocked
...
const stateLodashClone = (0, _cloneDeepJsDefault.default)(state);
...
console.log(person);
console.log((0, _shoppingCartJs.card).find((el)=>el.quantity >= 2));
...
parcelHelpers.export(exports, "prise", ()=>totalPrise);
parcelHelpers.export(exports, "tq", ()=>totalQuantity);
console.log("Start fetching users");
/*const res = await fetch(`https://jsonplaceholder.typicode.com/users`);
const data = await res.json();*/ console.log("Finish fetching users");
